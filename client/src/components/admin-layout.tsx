...
function AdminNavItem({
  ...
  return (
    <Link
      href={href}
      className={`flex items-center gap-3 rounded-[14px] border px-3 py-2.5 text-sm font-medium transition-all ${
        active
    ...
    <div className="site-shell min-h-screen">
      <div className="mx-auto flex w-full max-w-[1460px] flex-col gap-5 px-4 py-5 lg:grid lg:grid-cols-[248px_minmax(0,1fr)] lg:px-6">
        <aside className="w-full shrink-0 lg:sticky lg:top-5 lg:w-[248px] lg:self-start">
          <div className="site-panel rounded-[20px] p-3">
            ...
            <div className="mt-3 rounded-[14px] border border-black/5 bg-white/45 px-3 py-2.5 dark:border-white/10 dark:bg-white/[0.03]">
            ...
            <div className="mt-4">
              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <details className="group rounded-[14px] border border-black/5 bg-white/35 p-2 dark:border-white/10 dark:bg-white/[0.03]">
                  <summary className="flex cursor-pointer list-none items-center justify-between px-1 text-xs font-semibold uppercase tracking-[0.14em] text-neutral-400 transition group-open:text-theme">
                    维护工具
        ...
        <main className="min-w-0 flex-1">
          <div className="site-panel rounded-[22px] p-4 md:p-5">
            <div className="border-b border-black/5 pb-3 dark:border-white/5">
              <p className="site-kicker">{t("admin.title")}</p>
              <h1 className="mt-1.5 text-[1.25rem] font-semibold text-neutral-900 dark:text-white md:text-[1.5rem]">{title}</h1>
              <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-neutral-500 dark:text-neutral-300">{description}</p>
            </div>
